...
const Header = () => {
  return (
    ...
    <div className='header_wrapper'>
      <img src="" alt="" />
      <div className='katalog'>Katalog</div>
      <input type="text" placeholder='Mahsulotlar va turkumlarni izlash' />
      <ul className='header_like'><li><FaUser/></li>
      <li><svg
            data-v-ff0a7354=""
            width="20"
            height="20"
      ...
      <nav>
        ...
        <ul className='header_links'>
          ...
          <li><a href="/products">Maishiy Texnika</a></li>
          <li><a href="/about">Poyabzallar</a></li>
          <li><a href="/contact">Kiyim</a></li>
          <li><a href="/contact">Aksessuarlar</a></li>
          <li><a href="/contact">Go'zallik va Parvarish</a></li>
          <li><a href="/contact">Salomatlik</a></li>
          <li><a href="/contact">Uy-ro'zg'or buyumlari</a></li>
        </ul>
      </nav>
    </header>
  );
